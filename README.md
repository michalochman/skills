...
- **[external-docs](skills/external-docs/SKILL.md)** — Rules for a document that must stand alone for a reader outside the team, who cannot open your internal sources. Closes gaps (cite every claim to something the reader can reach, never "as agreed earlier") and cuts noise (name roles instead of products, drop reassurance and disclaimers, delete accurate detail the subject does not need). Most of the value is in what it removes.
